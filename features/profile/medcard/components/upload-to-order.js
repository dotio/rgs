...
export const UploadToOrder = ({medcardId}) => {
  ...
  return (
    <FileUploader
      text={translator('profile.medcard.upload-to-order.title', true)}
      dragActiveText={translator('profile.medcard.upload-to-order.subtitle', true)}
